...
less_than_28_days_freq <- as.data.frame(table(less_than_28_days$PATIENT_ID)) #1238 patients
...
consec_greater_than_3 <- as.data.frame(table(consec_greater_than_3$PATIENT_ID))#892 patients
...
proc_description_HIV <- hep_c_labs[grep("HIV", hep_c_labs$proc_description), ] #53339
...
HIV <- HIV[!duplicated(HIV),] #36,009 #LO: where did this come from? I have 985

##Evaluating when HIV test was compared to CBC labs
...
##  Freq of Hep B labs that occurred during CBC conse
